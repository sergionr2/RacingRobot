...
def processImage(image, debug=False, regions=None, interactive=False):
    ...
    if regions is None:
        ...
        regions = [r1, r2, r3]  # Before [r0, r1, r2]
    ...
    for idx, r in enumerate(regions):
        ...
        if debug:
            ...
            cv2.circle(im_cropped_tmp, (x_center, y_center), radius=10, color=(0, 0, 255), thickness=2, lineType=8,
                       shift=0)
    ...
    if debug:
        if all(errors):
            ...
            cv2.line(image, (image.shape[1] // 2, 0), (image.shape[1] // 2, image.shape[0]), color=(100, 0, 0),
